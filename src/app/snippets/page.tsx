        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-gradient-to-r
             from-blue-500/10 select-none to-purple-500/10 text-sm text-gray-400 mb-6"
          >
          ...
          <motion.h1
            ...
            className="text-4xl md:text-5xl font-bold select-none bg-gradient-to-r from-gray-100 to-gray-300 text-transparent bg-clip-text mb-6"
          >
          ...
          <motion.p
            ...
            className="text-lg text-gray-400 mb-8 select-none"
          >
            Explore a curated collection of code snippets from the community
          </motion.p>
          <div className="flex items-center justify-center m-auto gap-5">
            <Image src={"/cpp.png"} alt="cpp" width={"50"} height={"50"} />
            ...
            <Image
              ...
              height={"50"}
            />
            <Image src={"/ruby.png"} alt="ruby" width={"50"} height={"50"} />
            <Image
              src={"/csharp.png"}
              alt="csharp"
              width={"50"}
              height={"50"}
            />
            <Image src={"/go.png"} alt="go" width={"50"} height={"50"} />
            <Image src={"/rust.png"} alt="rust" width={"50"} height={"50"} />
            <Image src={"/swift.png"} alt="swift" width={"50"} height={"50"} />
          </div>
        </div>
