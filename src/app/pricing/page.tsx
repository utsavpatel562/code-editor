        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-24">
            <div className="relative inline-block">
              ...
              <h1
                className="relative select-none text-5xl md:text-6xl lg:text-7xl font-semibold bg-gradient-to-r
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto select-none">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-24">
            {ENTERPRISE_FEATURES.map((feature) => (
              <div
                key={feature.label}
                className="group relative bg-gradient-to-b from-[#12121a] to-[#15151f] rounded-2xl p-6 hover:transform hover:scale-[1.02] transition-all duration-300"
              >
